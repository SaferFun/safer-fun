    ...
    <div className="flex flex-col justify-center items-center w-full gap-12">
      ...
      <div className="mt-4">
        <p className="text-4xl text-theme-text transition-colors duration-300">
          we got you (for real),{" "}
          <Link
            href="https://github.com/SaferFun/safer-fun?tab=readme-ov-file#how-do-we-do"
            target="_blank"
      ...
      <div>
        <p className="text-4xl text-theme-text transition-colors duration-300">
          ...
          <Link
            href="https://github.com/SaferFun/safer-fun/tree/main#exploit-examples"
            target="_blank"
            rel="noopener noreferrer"
          >
